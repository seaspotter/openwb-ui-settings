<template>
  ...
  >
    Willst Du den Zeitplan "{{ plan.name }}" wirklich entfernen? Dieser Vorgang kann nicht rückgängig gemacht werden!
  </openwb-base-modal-dialog>
  <openwb-base-card
    :title="plan.name"
    :collapsible="true"
...
library.add(fasTrash, fasCopy, fasCalendarDay, fasCalendarAlt, fasCalendarWeek, fasClock);
